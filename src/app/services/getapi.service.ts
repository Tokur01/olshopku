...
export class GetapiService {
  ...
  token:any;
  dataResult = "error";
  APP_URL = "https://blackexpostore.401xd.com/";
  API_URL = "https://blackexpostore.401xd.com/mobileapi/";
  ...
  cariProduk(id) {
    return this.http.post(this.API_URL + 'cariproduk',{"cari":id}).pipe();
  }
  ...
  getReview(id) {
    return this.http.get(this.API_URL + 'getreview/'+id).pipe();
  }
